			 ...
			 <div className="thumbnail">
			 	<a href={posts} ><img className="imageList" src={posts} alt=""/></a>
			 	 <div className="caption">
			        ...
			        <p>...</p> 
			      	<p>{this.state.like==1?
			      		<a onClick={this.onClick2}  className="glyphicon glyphicon-heart" role="button"></a>
			      		:<a className="glyphicon glyphicon-thumbs-up" onClick={this.onClick}></a>}
			      	{this.state.like==1?
			      		<a onClick={this.onClick2} className="btn btn-default" style={{float:'right'}} role="button">Unsave</a>
			      		:<a onClick={this.onClick} className="btn btn-default" style={{float:'right'}} role="button">Save</a>}
